...
#### 아젠다 트랜잭션으로 데이타 생성하기 : 레거시 버전 (5개 파라미터)
 ...
 - **데이타 인코딩을 수작업으로 하기는 어려움이 있으므로, [다오 커뮤니티 버전의 sample-1](https://github.com/tokamak-network/dao-community-version/tree/main/sample-1#tokamak-dao-community-version-web-application) 의 배포된 앱을 이용하여 아젠다 생성을 권장한다.**
